...
- (void)glkView:(GLKView *)view drawInRect:(CGRect)rect {
    ...
    GLKMatrix4 scale = GLKMatrix4MakeScale(0.15, 0.15, 0.15);
    GLKMatrix4 translate = GLKMatrix4MakeTranslation(0, -1.0, -1.0);
    ...
    GLKMatrix4 cameraMatrix = GLKMatrix4MakeLookAt(0,1.0, 2, 0, 0, 0, 0, 1, 0);
